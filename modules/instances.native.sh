...
# Native instances will contains much more information than container instances.
# That additional information is needed in order to propperly create and manage
# the instance.
